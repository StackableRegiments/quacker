...
case class ScriptedCheck(serviceCheckMode:ServiceCheckMode, incomingName:String, incomingLabel:String, sequence:List[FunctionalServiceCheck], interpolator:Interpolator, time:TimeSpan) extends Pinger(incomingName,incomingLabel,serviceCheckMode){
