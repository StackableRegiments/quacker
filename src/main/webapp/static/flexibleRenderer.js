$(function(){
	...
	pluginSystem.subscribe('dataChanged','core.flexibleUpdateCheck',function(obj){internalUpdateCheck(obj);});

	pluginSystem.resumeCommand('dataChanged');
	pluginSystem.resumeCommand('layoutChanged');
});

pluginSystem.subscribe('retile','core.retile',function() {
...
pluginSystem.subscribe('renderCheckHtml','flexible.renderChecks',function(serviceNode,checks){
